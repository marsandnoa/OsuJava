...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        this.lastLeft.next.previous = addition;

        //create next and prev for new node
        addition.next = this.lastLeft.next;
        addition.previous = this.lastLeft;

        //update prev node
        this.lastLeft.next = addition;
    ...
    public final T removeRightFront() {
        ...
        Node target = this.lastLeft.next;
